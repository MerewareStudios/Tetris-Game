...
namespace Lofelt.NiceVibrations
{
    ...
    public static class HapticPatterns
    {
        ...
        static HapticPatterns()
        {
            ...
            Selection = new Preset(PresetType.Selection, new float[] { 0.0f, 0.0225f },
                                                         new float[] { 0.156f, 0.156f });

            Light = new Preset(PresetType.LightImpact, new float[] { 0.000f, 0.03f },
                                                       new float[] { 0.156f, 0.156f });

            Medium = new Preset(PresetType.MediumImpact, new float[] { 0.000f, 0.04f },
                                                         new float[] { 0.3f, 0.3f });

            Heavy = new Preset(PresetType.HeavyImpact, new float[] { 0.0f, 0.09f },
                                                       new float[] { 0.6f, 0.6f });
            ...
            Warning = new Preset(PresetType.RigidImpact, new float[] { 0.0f, 0.035f },
                new float[] { 1.0f, 1.00f });
        }
