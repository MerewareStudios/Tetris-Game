...
namespace Game
{
    public class Place : MonoBehaviour
    {
        ...
        public void Construct()
        {
            ...
            SpriteRenderer.color = GameManager.THIS.Constants.placeColors[(int)PlaceType.EMPTY];
        }
        ...
        public void SetColor(PlaceType placeType)
        {
            ...
            Color color = GameManager.THIS.Constants.placeColors[(int)placeType];
            if (placeType.Equals(PlaceType.EMPTY) && Merger)
            {
                color = GameManager.THIS.Constants.mergerColor;
            }
