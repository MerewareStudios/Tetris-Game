...
namespace Game
{
    public class Block : MonoBehaviour
    {
        ...
        public void Rotate()
        {
            ...
            motionTween?.Kill();
            motionTween = transform.DORotate(new Vector3(0.0f, 90.0f, 0.0f), Const.THIS.rotationDuration, RotateMode.FastBeyond360).SetRelative(true).SetEase(Const.THIS.rotationEase);
